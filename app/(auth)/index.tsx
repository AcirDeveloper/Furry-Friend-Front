...
export const LoginScreen = () => {
    ...
    return (
        <View style={styles.container}>
            ...
            <Animated.View style={[{position:'absolute', bottom:0, width:'100%', zIndex:2, overflow: 'hidden'}, animatedStyle]}>
                <View style={{position:'relative', width:'100%', height:'100%'}}>
                    <Image style={{position:'absolute',width:'100%', bottom:0, resizeMode:'stretch'}} source={require('@/assets/images/bannerErrorMessage.png')}/>
                    {/* <SvgError/> */}
                    <View style={{width:'100%',height:'100%' , display:'flex', 
                        justifyContent:'flex-end', alignItems:'center', paddingBottom:50}}>
                    ...
                    <Pressable onPress={onCloseMessage}
